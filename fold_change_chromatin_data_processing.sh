...
# Mouse
for file in aydin_0h_atac_1.sam.processed.bam aydin_12h_ascl1_atac_rep1.sam.processed.bam aydin_neurog2_12h_atac_rep1.sam.processed.bam \
...
lee_mef_atac.sam.processed.bam lee_ascl1_48h_atac_rep1.sam.processed.bam lee_myod1_48h_atac_rep1.sam.processed.bam \
wapinski_MEF.sam.processed.bam wapinski_MEF+Ascl1_48hr_B1_rep2.sam.processed.bam
do
...
for file in pereira_astrocytes_GSM6368722_ATACseq_GFP_rep1.sam.rmdup.bam pereira_astrocytes_GSM6368725_ATACseq_Ngn2_rep1.sam.rmdup.bam
do
...
# Human
cd ~/proneural
for file in park_atac_control_rep1.fastq.gz.sam.processed.bam park_atac_dox_rep1.fastq.sam.processed.bam
do
  sbatch --partition=bigmem --mem=400000 --wrap="macs2 callpeak -f BAM -t $file -g hs --outdir . -n $file"
done

cd ~/proneural/human/paired
for file in wang_ATAC_GIMEN_ASCL1_Neg_Rep1.sam.processed.bam wang_ATAC_GIMEN_ASCL1_Pos_Rep1.sam.processed.bam
do
  sbatch --partition=bigmem --mem=400000 --wrap="macs2 callpeak -f BAM -t $file -g hs --outdir . -n $file"
done
...
for file in *manandhar_GSM2449222_Fb_rep1_dnase*bam *manandhar_GSM2449225_Fd_rep1_dnase*bam
do
  sbatch --partition=bigmem --mem=400000 --wrap="macs2 callpeak -f BAM -t $file -g hs --outdir . -n $file"
done
...
concatenate_beds aydin_0h_atac_1.sam.processed.bam_peaks.narrowPeak aydin_12h_ascl1_atac_rep1.sam.processed.bam_peaks.narrowPeak "aydin_ascl1_12h_join"
concatenate_beds aydin_0h_atac_1.sam.processed.bam_peaks.narrowPeak aydin_48h_neurog2_atac_rep1.sam.processed.bam_peaks.narrowPeak "aydin_neurog2_48h_join"
...
concatenate_beds lee_mef_atac.sam.processed.bam_peaks.narrowPeak lee_myod1_48h_atac_rep1.sam.processed.bam_peaks.narrowPeak "lee_myod1_48h_join"
concatenate_beds lee_mef_atac.sam.processed.bam_peaks.narrowPeak lee_ascl1_48h_atac_rep1.sam.processed.bam_peaks.narrowPeak "lee_ascl1_48h_join"
concatenate_beds wapinski_MEF.sam.processed.bam_peaks.narrowPeak wapinski_MEF+Ascl1_48hr_B1_rep1.sam.processed.bam_peaks.narrowPeak "wapinski_ascl1_48hr_join"
concatenate_beds park_atac_control_rep1.fastq.gz.sam.processed.bam_peaks.narrowPeak park_atac_dox_rep1.fastq.sam.processed.bam_peaks.narrowPeak "park_ascl1_dox_join"
concatenate_beds pereira_astrocytes_GSM6368722_ATACseq_GFP_rep1.sam.rmdup.bam_peaks.narrowPeak pereira_astrocytes_GSM6368725_ATACseq_Ngn2_rep1.sam.rmdup.bam_peaks.narrowPeak "pereira_astrocytes_ngn2_join"
concatenate_beds wang_ATAC_GIMEN_ASCL1_Neg_Rep1.sam.processed.bam_peaks.narrowPeak wang_ATAC_GIMEN_ASCL1_Pos_Rep1.sam.processed.bam_peaks.narrowPeak "wang_ascl1_join"
concatenate_beds manandhar_GSM2449222_Fb_rep1_dnase.fastq.gz.sam.rmdup.sam.processed.bam_peaks.narrowPeak manandhar_GSM2449225_Fd_rep1_dnase.fastq.gz.sam.processed.bam_peaks.narrowPeak "manandhar_myod1_join"
...
##solo falta este. aunque no he conseguido hacer bien el peak calling
...
bedmap_chromatin aydin_ascl1_12h_join.bed clean.aydin_0h_atac_2.sam.processed.bam.bdg clean.aydin_12h_ascl1_atac_rep2.sam.processed.bam.bdg
bedmap_chromatin aydin_neurog2_48h_join.bed clean.aydin_0h_atac_2.sam.processed.bam.bdg clean.aydin_48h_neurog2_atac_rep2.sam.processed.bam.bdg
...
bedmap_chromatin lee_myod1_48h_join.bed clean.lee_mef_atac.sam.processed.bam.bdg clean.lee_myod1_48h_atac_rep1.sam.processed.bam.bdg
bedmap_chromatin lee_ascl1_48h_join.bed clean.lee_mef_atac.sam.processed.bam.bdg clean.lee_ascl1_48h_atac_rep1.sam.processed.bam.bdg
bedmap_chromatin wapinski_ascl1_48hr_join.bed clean.wapinski_MEF.sam.processed.bam.bdg clean.wapinski_MEF+Ascl1_48hr_B2_rep1.sam.processed.bam.bdg
bedmap_chromatin park_ascl1_dox_join.bed clean.park_atac_control_rep1.fastq.gz.sam.processed.bam.bdg clean.park_atac_dox_rep1.fastq.sam.processed.bam.bdg
...
bedmap_chromatin pereira_astrocytes_ngn2_join.bed clean.pereira_astrocytes_GSM6368722_ATACseq_GFP_rep1.sam.rmdup.bam.bdg clean.pereira_astrocytes_GSM6368725_ATACseq_Ngn2_rep1.sam.rmdup.bam.bdg
bedmap_chromatin wang_ascl1_join.bed clean.wang_ATAC_GIMEN_ASCL1_Neg_Rep1.sam.processed.bam.bdg clean.wang_ATAC_GIMEN_ASCL1_Pos_Rep1.sam.processed.bam.bdg
bedmap_chromatin manandhar_myod1_join.bed clean.manandhar_GSM2449222_Fb_rep1_dnase*bam.bdg clean.*manandhar_GSM2449225_Fd_rep1_dnase*bam.bdg
...
# raposo no me ha salido el peak calling
