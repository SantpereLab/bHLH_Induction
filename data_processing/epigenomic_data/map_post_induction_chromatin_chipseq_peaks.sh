...
setwd("~/proneural")
  ...
  bedmap_chromatin aydin_ascl1_eb_treatment_12h_confidence_1000bp_around_summit.bed clean.aydin_0h_atac_2.sam.processed.bam.bdg clean.aydin_12h_ascl1_atac.sam.processed.bam.bdg
  bedmap_chromatin aydin_neurog2_eb_treatment_48h_confidence_1000bp_around_summit.bed clean.aydin_0h_atac_2.sam.processed.bam.bdg clean.aydin_48h_neurog2_atac.sam.processed.bam.bdg
  ...
  bedmap_chromatin lee_myod1_mef_confidence_1000bp_around_summit.bed clean.lee_mef_atac.sam.processed.bam.bdg clean.lee_myod1_48h_atac.sam.processed.bam.bdg
  bedmap_chromatin wapinski_ascl1_mef_confidence_1000bp_around_summit.bed clean.wapinski_MEF.sam.processed.bam.bdg clean.wapinski_MEF+Ascl1_48hr_B2.sam.processed.bam.bdg
  bedmap_chromatin park_ascl1_glioblastoma_treatment_confidence_1000bp_around_summit.bed clean.park_atac_control.fastq.gz.sam.processed.bam.bdg clean.park_atac_dox.fastq.sam.processed.bam.bdg
  ...
  bedmap_chromatin pereira_neurog2_astrocytes_confidence_1000bp_around_summit.bed clean.pereira_astrocytes_GSM6368722_ATACseq_GFP.sam.rmdup.bam.bdg clean.pereira_astrocytes_GSM6368725_ATACseq_Ngn2.sam.rmdup.bam.bdg
  bedmap_chromatin wang_ascl1_gi-men_confidence_1000bp_around_summit.bed clean.wang_ATAC_GIMEN_ASCL1_Neg.sam.processed.bam.bdg clean.wang_ATAC_GIMEN_ASCL1_Pos.sam.processed.bam.bdg
  bedmap_chromatin manandhar_myod1_fibroblasts_confidence_1000bp_around_summit.bed clean.manandhar_GSM2449222_Fb_dnase*bam.bdg clean.*manandhar_GSM2449225_Fd_dnase*bam.bdg
