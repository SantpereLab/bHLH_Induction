...
# esta paso de momento porque no entiendo el formato de la file
cat GSM2138821_ENCFF333EXV_methylation_state_at_CpG_GRCh38.bed 

# solo end position y en las 4 y 5 numero de cpgs metiladas y no metiladas
...
# hESC. esta paso de momento pq no entiendo el formato de la file
methylation_in_quantiles human/joung_ascl1_hesc_confidence.bed hESC_fixed_GSM2138821_ENCFF333EXV_methylation_state_at_CpG_GRCh38.bed
