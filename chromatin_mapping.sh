    ...
    # alternativa
    mapp louphrasitthiphol_mitf_melanoma_treatment_confidence_1000bp_around_summit.bed ~/proneural/bdgs/clean.fontanals_501MEL_atac.processed.bam.bdg
    ...
    # ABC DLBCL (OCI-LY7 cell line)
    #mapp jain_tcf4_sudhl_confidence_1000bp_around_summit.bed ~/proneural/bdgs/clean.encode_H3K27ac_ChIP-seq_from_OCI-LY7.fastq.gz.sam.processed.bam.bdg
    #mapp jain_tcf4_tmd8_confidence_1000bp_around_summit.bed ~/proneural/bdgs/clean.encode_H3K27ac_ChIP-seq_from_OCI-LY7.fastq.gz.sam.processed.bam.bdg
