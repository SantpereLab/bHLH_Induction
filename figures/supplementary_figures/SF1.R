...
# For each induction, pick the timepoint with the most peaks
studies_renamed <- c(
...
# Select the studies that appear to have the E-box centrally enriched. By eye.
...
system("
  ...
  # List of mouse confidence files to process
  ...
  do
    # Create a 400bp window around the peak summit
    ...
    # Intersect with motif archetypes and keep specific columns
  ...
  # List of human confidence files to process
...
system("
  ...
  # Create a helper R script to summarize distances of motif archetypes from summits
  echo '
...
# Setting colors based on the central dinucleotide of the Ebox
ebox_colors <- c(
