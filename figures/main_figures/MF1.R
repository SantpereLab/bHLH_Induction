...
# Obtain the number of half sites per real peak size (within each study)
...
# reorder variable of flanking dinucleotide. first the ones with CAT, then CAC, then CAG, then CAA (as the last 3 nucleotides)
...
# Do it for all peaks in general, without dividing by quantiles
