...
# Create heatmaps that are like ribbons of the accessibility in tiny windows. 
# And then on top of that, place the boxes for the quantiles.
...
# try to do only with the proportions of distance 5 and 6
