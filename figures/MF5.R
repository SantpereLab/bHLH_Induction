...
############### puedo agrupar las gene ontologies, y despues puedo plotar cada grupo junto por cada gen. 
### plotando la variacion en plan de los NES. y dandole peso con el p value. tipo con boxplots. 
## y descartar las ontologies q no encajan en ningun grupo.

## bueno mejor q boxplot plotar los ballloon de cada ontology sobre un eje de la Y. todos estos balloons empaquetetados dentro del mismo gen/categoria

### solo he puesto los grupos que tienen suficientes ontologies
